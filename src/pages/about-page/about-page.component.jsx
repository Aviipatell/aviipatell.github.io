  ...
  <div className="aboutPage">
    ...
    <div className="content">
      ...
      <p>
        ...
        and I love creating things and bringing my ideas to life. I am driven by
        the desire to create positive change and I love getting to know new
        people.
      </p>
      <p>
      ...
      <p>
        Thanks for visiting, hope you enjoyed my site! If you have any questions
        or concerns or would like to get to know me better, feel free to reach
        out below! I’m always up for a cup of coffee.
      </p>
      ...
      <div className="buttonContainer">
        <CustomButton accent>Contact</CustomButton>
      </div>
      <Footer />
    </div>
  </div>
